...
- Multi-select (Cmd/Ctrl+click / Cmd/Ctrl+A / Alt+S siblings / Alt+C children / Alt+B subtree / Alt+P parent) + duplicate (Cmd/Ctrl+D, subtree-aware) + group drag + keyboard nudge (Alt+Arrow)
