...
- Help dialog (? / Cmd/Ctrl+/) toggle with toolbar Help On/Off state, compact Focus Navigation & History section, and live shortcut filter (punctuation-agnostic term matching; Esc clear-then-close + Cmd/Ctrl+F focus; Cmd/Ctrl+/ works even when typing in dialog inputs)
