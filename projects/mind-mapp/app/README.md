...
- Toolbar controls expose shortcut metadata (`aria-keyshortcuts`) across navigation/history/search/help/export/copy/reset actions for assistive-tech discoverability
